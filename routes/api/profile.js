...
// route to get api/profile/me
// det current user profile (private)
router.get('/me', auth, async (req, res) => {
  try {
    ...
    res.json(profile); //sends the profile if it exist.
  } catch (err) {
...
// route to Post api/profile
// create or update our user profile
// det current user profile (private)
